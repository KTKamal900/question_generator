...
class DatabaseHandler {
  ...
  Future<Database> _initDatabase() async {
    ...
    // if (path == null) {
    //   return Future.error('Couldn\'t get the default database location');
    // }
  ...
  Future<User?> getUser(
      {required String queryColName, required dynamic queryValue}) async {
  ...
  Future<int> update(
      {required User user, String? whereColName, dynamic? argument}) async {
    final Database db = await database;
